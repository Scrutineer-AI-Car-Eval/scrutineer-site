...
permalink: /terms/
description: The agreement between you and Scrutineer.
---
...
Scrutineer is sold as an auto-renewing subscription through the App Store. Full subscription and refund terms are in our [Subscription and Refund Terms](/subscriptions/), which form part of these terms.
...
- Use Scrutineer other than through the app we provide, including by scripting, scraping or automating it
- Try to bypass rate limits, the paywall, or any other restriction
- Send images you have no right to send, or content that is unlawful
- Send content designed to manipulate a score, or use Scrutineer to produce a score you then present to someone else as an independent assessment of a vehicle you are selling
- Reverse engineer, decompile or attempt to extract our scoring logic or prompts, except where that restriction is prohibited by law
- Use Scrutineer to build a competing product, or to train a machine learning model
- Interfere with the service, or with other users' use of it

We may limit, suspend or terminate access for breach of this section.

## 6. Your content, and our content

You keep ownership of everything you send us. You grant us a licence to use it for the limited purpose of providing the service — analysing it, generating your result, and storing the result as described in our [Privacy Policy](/privacy/). For content you post on the feedback board, that licence also covers displaying it publicly in the app. The licence ends when you delete the content, except for copies we must keep for moderation or legal reasons.
...
The board is governed by our [Board Community Rules](/board-rules/), which form part of these terms. Posts and comments are reviewed before they appear. We may remove content, restrict posting, or ban an account under those rules.
...
If any provision is unenforceable, the rest continues to apply. Our failure to enforce a provision is not a waiver of it. You may not assign these terms; we may assign them as part of a transfer of the business. These terms, together with the [Privacy Policy](/privacy/), the [Subscription and Refund Terms](/subscriptions/), and the [Board Community Rules](/board-rules/), are the entire agreement between us about Scrutineer.
